"""Main module for desktop_session class testing."""
...
TEST_MODULE = "custom_components.spotcast.sessions.desktop_session"


def get_mocked_session() -> tuple[DesktopSession, dict[str, MagicMock]]:
    ...
    with (
        ...
        session = DesktopSession(mocks["hass"], mocks["entry"])
